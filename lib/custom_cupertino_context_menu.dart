...
class CustomCupertinoContextMenu extends StatefulWidget {
  ...
  CustomCupertinoContextMenu({
    ...
    this.decoyChildAbsorbing = true,
    this.contextMenuChildAbsorbing = true,
  ...
  // Make the menu open when you press and hold it, not when you tap it.
  final bool enableLongPress;

  // Disables the Docoy Child tap event.
  final bool decoyChildAbsorbing;

  // Disables the ContextMenu Child tap event.
  final bool contextMenuChildAbsorbing;
  ...
  @override
  _CustomCupertinoContextMenuState createState() =>
...
class _CustomCupertinoContextMenuState extends State<CustomCupertinoContextMenu>
  ...
  void _openContextMenu() {
    ...
    _route = _ContextMenuRoute<void>(
      ...
      absorbing: widget.contextMenuChildAbsorbing,
    );
    ...
    _lastOverlayEntry = OverlayEntry(
      ...
      builder: (BuildContext context) {
        return _DecoyChild(
          ...
          absorbing: widget.decoyChildAbsorbing,
        );
      },
    );
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      onTapDown: widget.enableLongPress ? null : _onTapDown,
      onLongPress: widget.enableLongPress ? () => _onTapDown(null) : null,
      onTapUp: _onTapUp,
      onTap: _onTap,
      child: TickerMode(
